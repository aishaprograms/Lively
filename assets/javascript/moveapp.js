    ...
    $.ajax({ url: queryURL, method: 'GET' }).done(function(response) {
        ...
        var cardReveal = $('<div class="card-reveal"></div>');
            if(exercise === 'yoga'){
                ...
                cardReveal.append('\"Want to reduce body fat, increase lean muscle mass and burn calories more efficiently? Strength training to the rescue! Strength training is a key component of overall health and fitness for everyone.Use it or lose it <br><br>Lean muscle mass naturally diminishes with age. You\'ll increase the percentage of fat in your body if you don\'t do anything to replace the lean muscle you lose over time. Strength training can help you preserve and enhance your muscle mass at any age. <br><br>Strength training may also help you:<br><br><strong>Develop strong bones.</strong> By stressing your bones, strength training can increase bone density and reduce the risk of osteoporosis.<br><strong>Manage your weight.</strong> Strength training can help you manage or lose weight, and it can increase your metabolism to help you burn more calories.<br><strong>Enhance your quality of life.</strong> Strength training may enhance your quality of life and improve your ability to do everyday activities. Building muscle also can contribute to better balance and may reduce your risk of falls. This can help you maintain independence as you age.<br><strong>Manage chronic conditions.</strong> Strength training can reduce the signs and symptoms of many chronic conditions, such as arthritis, back pain, obesity, heart disease, depression and diabetes.<br><strong>Sharpen your thinking skills.</strong> Some research suggests that regular strength training and aerobic exercise may help improve thinking and learning skills for older adults.\"<br><br>-Mayo Clinic<br><br>Don\'t have a gym?  No problem! Check out <a href="https://www.nerdfitness.com/bodyweight-training-resources/">NerdFitness</a> for tips and advice on strength training without the equipment!');
            }
